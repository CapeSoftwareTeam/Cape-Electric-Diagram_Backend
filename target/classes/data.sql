...
CREATE TABLE GENERAL_TESTING_MCB(
			...
			CONSTRAINT FK_MCB_ID FOREIGN KEY(MCB_ID) REFERENCES MCB(MCB_ID) ON DELETE CASCADE
			);
...
CREATE TABLE GENERAL_TESTING_RCBO(
			...
			CONSTRAINT FK_RCBO_ID FOREIGN KEY(RCBO_ID) REFERENCES RCBO(RCBO_ID) ON DELETE CASCADE
			);
