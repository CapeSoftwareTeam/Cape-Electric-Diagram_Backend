...
public class NodeFileUploadController<V> {
	...
	@PostMapping("/uploadNodeFile/{nodeId}/{fileSize}")
	...
	@GetMapping("/downloadNodeFile/{component}/{nodeId}")
	public ResponseEntity<String> downloadFile(@PathVariable String component, @PathVariable String nodeId, HttpServletResponse response)
		...
		ResponseFile fileDB = nodesFileStorageService.downloadFile(nodeId);
	...
	@GetMapping("/retrieveNodeFileName/{component}/{nodeId}")
	public ResponseEntity<Map> retrieveFileNameByNoded(@PathVariable String component,@PathVariable String nodeId) throws IOException, SQLException {
		...
		ResponseFile fileDB = nodesFileStorageService.retrieveFileNameByNodeId(nodeId);
		if(null != fileDB) {
	...
	@PutMapping("/updateNodeFile/{fileId}/{fileSize}")
	...
	@DeleteMapping("/removeNodeFile/{component}/{nodeId}")
